                ...
                {projects.map((project) =>
                    <div key={project.id} className="project">
                        ...
                        <div className="actions">
                            {<>
                                <a key={project.buttons[0].id} className="action demo" style={{ backgroundColor: project.buttons[0].color }} href={project.buttons[0].url} target="_blank">
                                    {project.buttons[0].title}
                                    <svg
                                        width={20}
                                        height={20}
                                        viewBox="0 0 24 24"
                                ...
                                <a key={project.buttons[1].id} className="action github" style={{ backgroundColor: project.buttons[1].color }} href={project.buttons[1].url} target="_blank">
                                    <svg
                                        width={20}
                                        height={20}
                                        viewBox="0 0 24 24"
